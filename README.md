...
```sh
git clone git@github.com:BabyManisha/sol-counter.git
```
...
6. Deploy the anchor project

```sh
anchor deploy
```

1. Update the project ID in the Rust program located at __projectname/programs/src/programname.rs__ with the output from above.
